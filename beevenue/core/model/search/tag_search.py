...
class TagSearch(object):
    ...
    def _get_implications(self, terms):
        ...
        return (implication_map, implying_tag_strings)

    def _evaluate_medium(
            self, medium, term_strings, implication_map,
            implying_tag_strings, is_and, results):
    ...
    def evaluate(self, terms, is_and):
        ...
        implication_map, implying_tag_strings = self._get_implications(terms)

        results = []

        for medium in self.all_media:
            self._evaluate_medium(
                medium, term_strings, implication_map,
                implying_tag_strings, is_and, results)
